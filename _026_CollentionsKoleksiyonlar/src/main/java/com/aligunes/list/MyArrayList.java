...
public class MyArrayList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Arama 3 : " + list2.contains(list3));

        System.out.println("List boyutu : " + list3.size());

        System.out.println("Liste dolu mu? : " + !list3.isEmpty());

      //  list3.clear(); // liste temizleme işlemi       // eğer bu kısmı silmezsek. Herhangi bir değer olmadığı çin hata verir. Çünkü LİSTEYİ SIFIRLADıK
